...
Single Dataset Analysis , Target Variable Analysis , Compare two datasets, Divide Dataset using boolean variable and Compare them.''')
	def Feed(self):
		...
		def add_feedback(date_submitted, Name, Age,Gender,Company,Rating ,Q6,Contact Info, Quires):
			c.execute('INSERT INTO feedback (date_submitted, Name, Age,Gender,Company,Rating ,Q6,Contact Info, Quires) VALUES (?,?,?,?,?,?,?,?,?)',(date_submitted,Name, Age,Gender, Company,Rating ,Q6,Contact Info, Quires))
			conn.commit()
